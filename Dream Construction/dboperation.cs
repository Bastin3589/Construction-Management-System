...
namespace Dream_Construction
{
    public class dboperation
    {
        ...
        public dboperation()
        {
            // con.ConnectionString = "Data Source=.;Initial Cat  alog=santhisoft;Integrated Security=True;Pooling=False";

            string conn = ConfigurationManager.ConnectionStrings["dream"].ConnectionString;
        ...
        //fillradio
        public void fillradio(String sql, RadioButtonList rb, String txt, String val)
        {
            rb.DataTextField = txt;
            rb.DataValueField = val;
            rb.DataSource = exedataset(sql);
            rb.DataBind();
