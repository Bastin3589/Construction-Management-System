<%@ Page Title="" Language="C#" MasterPageFile="PaymentMaster.Master" AutoEventWireup="true" CodeBehind="fifth.aspx.cs" Inherits="Dream_Construction.payment.fifth" %>
                    ...
                    <table class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td class="auto-style38">
                                <asp:Label ID="lblAmoubnt" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style36">Transaction ID</td>
                            <td class="auto-style37"></td>
                            <td class="auto-style38">Payment-<asp:Label ID="lblTID" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" class="auto-style21" style="text-align: center">
                                <asp:Button ID="Button1" runat="server" Text="Continue" Width="108px" OnClick="Button1_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
